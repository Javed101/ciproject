        ...
        <main class="page-content content-wrap">
            <div class="navbar">
                <div class="navbar-inner container">
                    ...
                    <div class="logo-box">
                        <a href="#" class="logo-text"><span>Welcome</span></a>
                    </div><!-- Logo Box -->
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-list" role="menu">
                                        ...
                                        <li role="presentation" class="divider"></l
                                        	i>
                                        <li role="presentation"><a href="lock-screen.html"><i class="fa fa-lock"></i>Lock screen</a></li>
                                        <li role="presentation"><a href="<?=(base_url().'User/logout')?>"><i class="fa fa-sign-out m-r-xs"></i>Log out</a></li>
                                    </ul>
                                </li>
                                <li>
